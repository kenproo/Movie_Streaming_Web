  ...
  return (
    <header className="app-header sticky top-0 z-40 border-b backdrop-blur">
      <div className="mx-auto flex w-full max-w-[1600px] items-center gap-3 px-4 py-3 sm:px-6 lg:px-10 xl:px-16">
        ...
        <nav className="hidden min-w-0 flex-1 items-center gap-4 xl:gap-6 xl:flex xl:ml-12">
          {navItems.map((item) => (
            <NavLink
              key={item.to}
              to={item.to}
              className={({ isActive }) => {
                ...
                return [
                  'whitespace-nowrap rounded-xl px-4 py-2.5 text-[15px] font-bold transition',
                  isTabActive
        ...
        <div className="relative hidden min-w-0 md:flex md:w-[260px] lg:w-[300px] xl:w-[360px] 2xl:w-[420px] ml-auto">
