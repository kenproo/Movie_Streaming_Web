...
export function LoginPage() {
  ...
  return (
    <div className="relative mx-auto flex max-w-5xl items-center justify-center py-2 sm:py-4 animate-page-in">
      ...
      {/* Main Container Card */}
      <div className="w-full grid overflow-hidden rounded-[2.5rem] border border-slate-200/80 dark:border-white/10 bg-white/90 dark:bg-[#0d1224]/85 backdrop-blur-2xl shadow-2xl dark:shadow-[0_0_50px_rgba(6,182,212,0.05)] lg:grid-cols-[1fr_390px] transition-all duration-500 hover:border-cyan-500/20">
        ...
        <div className="p-6 sm:p-8 flex flex-col justify-center">
          ...
          <h1 className="mt-4 text-2xl font-black tracking-tight text-slate-900 dark:text-white sm:text-3xl">Đăng nhập</h1>
          <p className="mt-1 text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
            Xem trọn vẹn kho phim chất lượng cao 4K, lưu trữ danh sách yêu thích và sử dụng trợ lý RAG AI.
          </p>
 
          <form onSubmit={submitForm} className="mt-4 space-y-4" noValidate>
            {/* Email Field */}
            <div className="space-y-1">
              ...
              <div className={`relative group ${emailError ? 'animate-shake' : ''}`}>
                ...
                <input
                  ...
                  className={[
                    'w-full rounded-2xl border pl-11 pr-4 py-2.5 text-xs text-slate-900 dark:text-white bg-slate-50/50 dark:bg-slate-950/40 outline-none transition-all duration-300',
            ...
            <div className="space-y-1">
              ...
              <div className={`relative group ${passwordError ? 'animate-shake' : ''}`}>
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={[
                    'w-full rounded-2xl border pl-11 pr-12 py-2.5 text-xs text-slate-900 dark:text-white bg-slate-50/50 dark:bg-slate-950/40 outline-none transition-all duration-300',
                    'focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-400 dark:focus:border-cyan-400/80',
            ...
            {error && (
              <div className="rounded-2xl border border-red-500/20 bg-red-500/10 px-4 py-2.5 text-[11px] font-semibold text-red-500 animate-shake">
                {error}
              </div>
            )}
        ...
        <div className="relative hidden flex-col justify-between border-l border-slate-200/50 dark:border-white/5 bg-slate-50/30 dark:bg-slate-950/15 p-6 sm:p-8 lg:flex">
          <div className="space-y-4">
            <div>
              <h2 className="text-sm font-black text-slate-900 dark:text-white">Tài khoản trải nghiệm</h2>
            ...
            <div className="space-y-2.5">
              ...
              <button
                ...
                className="w-full flex items-start gap-3 rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-white/[0.03] p-3 text-left transition-all duration-300 hover:border-lime-400/30 hover:bg-lime-400/5 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-lime-500/5 group cursor-pointer"
              >
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-lime-400/10 text-lime-400 group-hover:bg-lime-400 group-hover:text-slate-950 transition">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[10px] text-slate-500 dark:text-slate-400 leading-normal">Xem báo cáo, cấu hình chatbot.</p>
                </div>
              </button>
              ...
              <button
                ...
                className="w-full flex items-start gap-3 rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-white/[0.03] p-3 text-left transition-all duration-300 hover:border-cyan-400/30 hover:bg-cyan-400/5 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-cyan-500/5 group cursor-pointer"
              >
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-cyan-400/10 text-cyan-400 group-hover:bg-cyan-400 group-hover:text-slate-950 transition">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[10px] text-slate-500 dark:text-slate-400 leading-normal">Xem phim mẫu, chat với AI.</p>
                </div>
              </button>
            </div>
          </div>
 
          <div className="rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-white/[0.02] p-3 text-center">
            <span className="text-[9px] uppercase font-bold tracking-widest text-slate-400">ChillFilm Streaming</span>
            <p className="mt-0.5 text-[10px] text-slate-500 dark:text-slate-400">Version 2.0 (Powered by RAG AI)</p>
          </div>
        </div>
